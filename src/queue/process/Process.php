...
namespace think\queue\process;

use think\queue\process\exception\Failed as ProcessFailedException;
use think\queue\process\exception\Timeout as ProcessTimeoutException;
use think\queue\process\pipes\Pipes;
use think\queue\process\pipes\Unix as UnixPipes;
use think\queue\process\pipes\Windows as WindowsPipes;
